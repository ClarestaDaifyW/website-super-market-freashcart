            ...
            <div class="container">
               ...
               <div class="row justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                     ...
                     <!-- form -->
                    <form action="../auth/register.php" method="POST" class="row g-3">

                        <div class="col-6">
                           <!-- input -->
                           <label for="formSignupfname" class="form-label visually-hidden">First Name</label>
                           <input type="text" class="form-control" id="formSignupfname" name="first_name" placeholder="Nama Depan" required />
                           <div class="invalid-feedback">Please enter first name.</div>
                        </div>
                        <div class="col-6">
                           <!-- input -->
                           <label for="formSignuplname" class="form-label visually-hidden">Last Name</label>
                           <input type="text" class="form-control" id="formSignuplname" name="last_name" placeholder="Nama Belakang" />
                           <div class="invalid-feedback">Please enter last name.</div>
                        </div>
                        <div class="col-12">
                           <!-- input -->
                           <label for="formSignupEmail" class="form-label visually-hidden">Email address</label>
                           <input type="email" class="form-control" id="formSignupEmail" name="email" placeholder="Email" required />
                           <div class="invalid-feedback">Please enter email.</div>
                        </div>
                        <div class="col-12">
                           <!-- input -->
                           <label for="formSignupPhone" class="form-label visually-hidden">Phone Number</label>
                           <input type="tel" class="form-control" id="formSignupPhone" name="phone" placeholder="No HP" required />
                           <div class="invalid-feedback">Please enter phone number.</div>
                        </div>
                        <div class="col-12">
                           <!-- input -->
                           <label for="formSignupPassword" class="form-label visually-hidden">Password</label>
                           <input type="password" class="form-control" id="formSignupPassword" name="password" placeholder="Password" required />
                           <div class="invalid-feedback">Please enter password.</div>
                        </div>
                        <!-- btn -->
                        <div class="col-12 d-grid"><button type="submit" class="btn btn-primary" name="register">Daftar</button></div>
